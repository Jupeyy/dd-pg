- high prio:
    ...
    - sound backend should recover forcepaused scnenes/streams/sounds/listeners
    ...
    - GPL code must be removed (snailquote)
    - Ghost, demo recorder server
    - Merge https://github.com/ddnet/ddnet/pull/9137
    - Add player join & leave skin
