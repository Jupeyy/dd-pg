...
pub struct SwapchainKHR {
    pub ash_swapchain: ash::extensions::khr::Swapchain,
...
impl SwapchainKHR {
    pub fn new(instance: &ash::Instance, device: &ash::Device) -> anyhow::Result<HiArc<Self>> {
        let ash_swapchain = ash::extensions::khr::Swapchain::new(instance, device);
        Ok(HiArc::new(Self {
            ash_swapchain,
    ...
    ) -> anyhow::Result<HiArc<Self>, vk::Result> {
