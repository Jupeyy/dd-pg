...
use super::{memory_allocator::MemoryAllocator, phy_device::PhyDevice};
...
pub struct LogicalDevice {
    ...
    pub memory_allocator: spin::Mutex<MemoryAllocator>,
...
impl LogicalDevice {
    pub fn new(
        ...
        Ok(Arc::new(Self {
            ...
            memory_allocator: spin::Mutex::new(MemoryAllocator::new(
                device,
                dbg,
