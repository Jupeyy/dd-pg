...
use graphics_types::{
    commands::{
        ...
        CommandUpdateViewport, Commands, CommandsRender, CommandsRenderMod,
...
impl VulkanBackend {
    ...
    fn command_cb_misc(&mut self, cmd_param: Commands) -> anyhow::Result<()> {
        match cmd_param {
            ...
            Commands::ConsumeMultiSamplingTargets => self.cmd_consume_multi_sampling_targets(),
    ...
    */
    ...
    ) -> anyhow::Result<((Arc<Buffer>, Arc<DeviceMemoryBlock>), usize)> {
    ...
    fn create_surface(
        ...
        unsafe { surface.create_vk_surface(entry, instance, raw_window, mem_allocator) }?;
    ...
    pub fn init_from_main_thread(
        ...
        Ok(VulkanMainThreadInit { surface })
    }
