...
pub struct Memory {
    ...
    pub logical_device: HiArc<LogicalDevice>,
...
impl Memory {
    ...
    ) -> anyhow::Result<HiArc<DeviceMemoryBlock>, MemoryAllocationError> {
    ...
    >(
        &self,
        memory_cache: &HiArc<spin::Mutex<MemoryCache>>,
    ...
    where
        FAlloc: FnOnce(
            ...
            (Option<HiArc<Buffer>>, HiArc<DeviceMemoryBlock>),
        ...
        >,
    {
        ...
        if required_size < MEMORY_BLOCK_SIZE as vk::DeviceSize {
            let create_or_find_cache_block = || {
                ...
                let cache_heap: Option<(Option<HiArc<Buffer>>, Option<MappedMemoryOffset>)>;
                let mut found_id = 0;
    ...
    fn get_image_memory_impl(
        ...
        buffer_properties: vk::MemoryPropertyFlags,
    ) -> anyhow::Result<HiArc<DeviceMemoryBlock>, BufferAllocationError> {
        let mut mem_alloc_info = vk::MemoryAllocateInfo::default();
