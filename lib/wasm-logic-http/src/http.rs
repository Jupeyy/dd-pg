...
pub struct WasmHttpLogicImpl {
    pub io: Io,
    tasks: RefCell<HashMap<u64, IoBatcherTask<String>>>,
    bin_tasks: RefCell<HashMap<u64, IoBatcherTask<Bytes>>>,
...
impl WasmHttpLogicImpl {
    ...
    fn download_text(&self, task_id: u64, url: Url) -> Option<Result<String, String>> {
    ...
    fn download_binary(&self, task_id: u64, url: Url, hash: Hash) -> Option<Result<Bytes, String>> {
...
impl WasmHttpLogic {
    ...
    pub fn get_wasm_logic_imports(
        ...
        fn download_text(
            ...
            let url: Url = read_param(instance.as_ref().unwrap(), &mut store, &mut param0, 0);
            let task_id: u64 = read_param(instance.as_ref().unwrap(), &mut store, &mut param0, 1);
        ...
        fn download_binary(
            ...
            let (mut param0, instance) = data.param_index_mut(0);
            let url: Url = read_param(instance.as_ref().unwrap(), &mut store, &mut param0, 0);
            let hash: Hash = read_param(instance.as_ref().unwrap(), &mut store, &mut param0, 1);
            let task_id: u64 = read_param(instance.as_ref().unwrap(), &mut store, &mut param0, 2);
        ...
        fn post_json(
            ...
            let (mut param0, instance) = data.param_index_mut(0);
            let url: Url = read_param(instance.as_ref().unwrap(), &mut store, &mut param0, 0);
            let data: Vec<u8> = read_param(instance.as_ref().unwrap(), &mut store, &mut param0, 1);
            let task_id: u64 = read_param(instance.as_ref().unwrap(), &mut store, &mut param0, 2);
