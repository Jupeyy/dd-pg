use egui::{text::LayoutJob, FontId, Response, RichText, TextFormat, Ui};
...
pub fn append_icon_font_text(job: &mut LayoutJob, ui: &egui::Ui, text: &str, text_size: f32) {
    job.append(
        text,
        0.0,
        TextFormat {
            font_id: FontId::new(text_size, egui::FontFamily::Name("icons".into())),
...
pub fn icon_font_text_for_btn(ui: &egui::Ui, text: &str) -> RichText {
    let size = ui
        .style()
        .text_styles
        ...
        .unwrap()
        .size;
    icon_font_text_sized(text, size)
}

pub fn icon_font_text_for_text(ui: &egui::Ui, text: &str) -> RichText {
    let size = ui
        .style()
        .text_styles
...
pub fn icon_font_text_sized(text: &str, text_size: f32) -> RichText {
    RichText::new(text)
        .font(FontId::new(
            text_size,
            egui::FontFamily::Name("icons".into()),
        ))
        // font awesome letters are always weirdly aligned
        .line_height(Some(text_size - 1.0))
}

pub fn icon_font_plus_text(ui: &egui::Ui, icon: &str, text: &str) -> LayoutJob {
    let mut job = LayoutJob::default();
    append_icon_font_text(&mut job, ui, icon, 12.0);
    job.append(
        text,
        5.0,
        TextFormat {
...
pub fn text_plus_icon_font(ui: &egui::Ui, text: &str, icon: &str) -> LayoutJob {
    let mut job = LayoutJob::default();
    job.append(
        text,
        5.0,
