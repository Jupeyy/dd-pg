...
enum SoundStreamSpeed {
    None,
    TooSlow,
    TooFast,
}

struct SoundStreamResampled {
...
pub struct SoundStream {
    ...
    _microphone_inner: Option<Box<dyn MicrophoneStreamRaii>>,
    // thread last
...
impl SoundStream {
    pub fn from_receiver(
        ...
        inner: Option<Box<dyn MicrophoneStreamRaii>>,
    ...
    pub fn new(microphone: MicrophoneStream, settings: SoundStreamsettings) -> Self {
