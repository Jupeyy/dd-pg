...
impl WinitWindowWrapper {
        ...
        let video_mode = monitor
            ...
            .or_else(|| {
                ...
                monitor.video_modes().find(|video_mode| {
                    video_mode.size().width == wnd.width && video_mode.size().height == wnd.height
                })
            });
    ...
    fn fullscreen_mode(
        ...
        if !wnd.fullscreen && wnd.maximized && !wnd.decorated {
            ...
            if let Some(video_mode) = video_mode.or_else(|| monitor.video_modes().next()) {
...
impl WinitWrapper {
        ...
        F: FromNativeLoadingImpl<L>,
    {
        ...
        let mut window_builder = winit::window::WindowBuilder::new()
            ...
            .with_resizable(true)
            .with_active(true)
            .with_min_inner_size(Size::Logical(winit::dpi::LogicalSize {
                width: 50.0,
                height: 50.0,
            }))
