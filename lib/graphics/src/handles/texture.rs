pub mod texture {
    ...
    use graphics_types::{
        commands::{
            ...
            CommandsMisc, TexFlags, TexFormat,
        },
    ...
    impl GraphicsTextureHandle {
                ...
                for y in 0..src_height {
                    for x in 0..src_width {
                        ...
                        if src_channel_count == 3 {
                            ...
                            data_slice.as_mut_slice()[img_offset_dest] = 255;
        ...
        fn load_texture_impl(
            ...
            let tmp_buff_data = self.convert_to_rgba(data, width, height, format, flags);
