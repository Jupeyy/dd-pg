...
use graphics_types::{
    command_buffer::{
        ...
        CommandsRenderStream, PrimType, RenderCommand, SQuadRenderInfo, SRenderSpriteInfo,
        StreamDataMax, TexFlags, TexFormat,
    },
    rendering::{ColorRGBA, RenderMode, State, WriteVertexAttributes},
...
impl<'a, B: GraphicsBackendInterface> StagingGraphics<'a, B> {
    pub fn load_texture(
        &mut self,
        width: usize,
        height: usize,
...
impl<B: GraphicsBackendInterface> GraphicsBackendHandleInterface for GraphicsBackendHandle<B> {
    ...
    fn mem_alloc(&mut self, alloc_type: GraphicsMemoryAllocationType) -> GraphicsBackendMemory {
    ...
    fn flush_vertices(
        ...
        if flush_vertices_impl(
            ...
            let render_cmd = match render_mode {
                ...
                RenderMode::FillStencil => CommandsRenderStream::RenderStencil { cmd },
                RenderMode::StencilNotPassed { clear_stencil } => {
                    CommandsRenderStream::RenderStencilNotPased {
                        cmd,
...
impl<B: GraphicsBackendInterface> GraphicsQuadContainerHandleInterface
...
impl<B: GraphicsBackendInterface> GraphicsBufferObjectHandle<B> {
...
impl<B: GraphicsBackendInterface> GraphicsBufferObjectHandleInterface
...
impl<B: GraphicsBackendInterface> GraphicsTextureHandle<B> {
...
impl<B: GraphicsBackendInterface> GraphicsTextureHandleInterface for GraphicsTextureHandle<B> {
...
impl<B: GraphicsBackendInterface> GraphicsBase<B> {
    pub fn new(
        backend: B,
        stream_data: Rc<RefCell<dyn GraphicsStreamDataInterface>>,
        window: WindowProps,
    ...
    pub fn next_switch_pass(&mut self) {
        self.backend_handle
...
impl<B: GraphicsBackendInterface> GraphicsSizeQuery for GraphicsBase<B> {
    ...
    fn window_pixels_per_point(&self) -> f32 {
        self.window_props.canvas_width as f32 / self.window_props.window_width as f32
    }
}
...
impl<B: GraphicsBackendInterface> GraphicsStreamHandleInterface for GraphicsBase<B> {
    ...
    fn flush_vertices(
        ...
        self.stream_handle
            .flush_vertices(state, render_mode, vertices_offset, draw_mode)
    }
...
impl<B: GraphicsBackendInterface> GraphicsHandlesInterface for GraphicsBase<B> {
...
impl<B: GraphicsBackendInterface> GraphicsInterface for GraphicsBase<B> {}
