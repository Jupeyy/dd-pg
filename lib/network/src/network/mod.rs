...
pub mod tests {
    ...
    use crate::network::{
        network::{
            Network, NetworkClientCertCheckMode, NetworkClientCertMode, NetworkServerCertAndKey,
            NetworkServerCertMode,
        },
    ...
    use super::{
        ...
        network::{
            ...
            NetworkEndpointInterface, NetworkIncomingInterface, NetworkServerInitOptions,
        },
        ...
        E: NetworkEndpointInterface<Z, I>,
    {
        ...
        let (network_server, _, addr, notifier_server) = Network::<E, C, Z, I>::init_server(
            "0.0.0.0:0",
        ...
        let (client_cert, client_private_key) = create_certifified_keys();
        let (mut network_client, notifier) = Network::<E, C, Z, I>::init_client(
            "0.0.0.0:0",
        ...
        let (client_cert, client_private_key) = create_certifified_keys();
        let (mut network_client2, _notifier2) = Network::<E, C, Z, I>::init_client(
            "0.0.0.0:0",
        ...
        let (client_cert, client_private_key) = create_certifified_keys();
        let (mut network_client3, _notifier3) = Network::<E, C, Z, I>::init_client(
            "0.0.0.0:0",
        ...
        let test_case = |network_client: &mut Network<E, C, Z, I>| {
            // reliable in order
