...
impl WasmGraphicsLogicImpl {
    fn new(graphics: &mut Graphics, backend: Rc<GraphicsBackend>, id_offset: u128) -> Self {
        Self {
...
impl WasmGraphicsLogic {
    pub fn new(graphics: &mut Graphics, backend: Rc<GraphicsBackend>, id_offset: u128) -> Self {
