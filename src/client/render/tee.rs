...
use graphics_render_traits::GraphicsInterface;
use graphics_types::{
...
use crate::containers::skins::Skin;
...
impl RenderTee {
    ...
    pub fn destroy(self, graphics: &mut Graphics) {
        graphics.delete_quad_container(self.tee_quad_container)
    }
    ...
    pub fn render_tee_body(
        ...
        let (backend_handle, quad_container_handle) = graphics.get_render_handles();
        let mut quad_scope = backend_handle.quad_scope_begin();
