...
use graphics_base::{
    ...
    streaming::{quad_scope_begin, DrawScopeImpl, GraphicsStreamHandleInterface},
};
use graphics_types::{
...
impl Render {
    ...
    pub fn render_projectile(
        ...
        let weapon = pipe
            .weapon_container
            .get_or_default(weapon_name, pipe.graphics);
    ...
    pub fn render_pickup(
        ...
        let pickup_tex = pipe
            .pickup_container
            .get_or_default("default", pipe.graphics);
    ...
    pub fn render_flag(
        ...
        let ctf_tex = pipe.ctf_container.get_or_default("default", pipe.graphics);
    ...
    pub fn render_laser(
        ...
        if laser_len > 0.0 {
            ...
            // do outline
            let mut quad_scope = pipe.graphics.quads_begin();
            quad_scope.set_state(base_state);
