...
use shared_base::{
    game_types::time_until_tick, local_server_info::LocalServerInfo,
    network::messages::MsgClSnapshotAck,
};
    ...
    pub fn on_msg(
        ...
        match msg {
            ...
            ServerToClientMessage::Snapshot {
                ...
                if pipe.game_data.handled_snap_id.is_none_or(|id| id < snap_id) {
