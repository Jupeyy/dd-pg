...
use game_interface::{
    types::{
        game::GameTickType, id_types::PlayerId, input::CharacterInputInfo,
        snapshot::SnapshotLocalPlayers, weapons::WeaponType,
    },
...
pub struct GameData {
    ...
    pub player_inp_pool: Pool<LinkedHashMap<PlayerId, PlayerInput>>,
    pub player_snap_pool: Pool<Vec<u8>>,
    pub player_inputs_state_pool: Pool<LinkedHashMap<PlayerId, CharacterInputInfo>>,
    pub player_ids_pool: Pool<LinkedHashSet<PlayerId>>,
