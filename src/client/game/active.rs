...
use game_interface::{
    events::GameEvents,
    types::{game::GameTickType, id_types::PlayerId},
};
...
pub struct ActiveGame {
    ...
    pub render_players_pool: Pool<LinkedHashMap<PlayerId, RenderGameForPlayer>>,
    pub render_observers_pool: Pool<Vec<ObservedPlayer>>,

    pub player_inputs_pool: Pool<LinkedHashMap<PlayerId, PoolVec<PlayerInputChainable>>>,
    pub player_inputs_chainable_pool: Pool<Vec<PlayerInputChainable>>,
    pub player_inputs_chain_pool: MtPool<LinkedHashMap<PlayerId, MsgClInputPlayerChain>>,
...
impl ActiveGame {
    pub fn send_input(
        &mut self,
        player_inputs: &LinkedHashMap<PlayerId, PoolVec<PlayerInputChainable>>,
