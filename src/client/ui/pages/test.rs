...
use egui::{widgets::color_picker::show_color, *};
use game_config::config::Config;
use ui_traits::traits::UIRenderCallbackFunc;

const GRADIENT_SIZE: Vec2 = vec2(256.0, 18.0);

const _BLACK: Color32 = Color32::BLACK;
...
impl ColorTest {
    pub fn new() -> Self {
        Self {
            ...
            vertex_gradients: Default::default(),
            texture_gradients: Default::default(),
        }
    }
    ...
    fn tex_gradient(&mut self, ui: &mut Ui, label: &str, bg_fill: Color32, gradient: &Gradient) {
        ...
        ui.horizontal(|ui| {
            ...
            ui.add(Image::new(tex).bg_fill(bg_fill).uv(uv))
...
impl UIRenderCallbackFunc<Config> for ColorTest {
...
impl Gradient {
    pub fn _one_color(srgba: Color32) -> Self {
...
fn _mul_color_gamma(left: Color32, right: Color32) -> Color32 {
    Color32::from_rgba_premultiplied(
