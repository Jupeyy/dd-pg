...
use base_fs::io_batcher::TokIOBatcher;
use client_render::render::{
...
impl TeeEditor {
    ...
    fn render_anim_preview(
        ...
        let stream_handle = &mut graphics.stream_handle;
        let mut lines = stream_handle.lines_begin();
        lines.lines_draw_tl(&[
            Line {
...
impl UIRenderCallbackFunc<UIWinitWrapper, GraphicsBackend> for TeeEditor {
    fn render(
        &mut self,
        ui: &mut egui::Ui,
        pipe: &mut UIPipe<UIWinitWrapper>,
