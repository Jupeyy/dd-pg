...
pub type ClientPlayerInputPerTick =
    LinkedHashMap<GameTickType, PoolLinkedHashMap<PlayerId, PlayerInput>>;
...
pub type LocalPlayers = LinkedHashMap<PlayerId, ClientPlayer>;
...
impl ClientPlayer {
    pub fn get_and_update_latest_input(
        ...
        player_inputs: &mut LinkedHashMap<PlayerId, PoolVec<PlayerInputChainable>>,
