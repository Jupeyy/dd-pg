...
use graphics::graphics_mt::GraphicsMultiThreaded;
...
impl STileVisual {
    pub fn drawable(&self) -> bool {
        return (self.quad_count_and_is_drawable_flag & 0x10000000) != 0;
    }
    ...
    pub fn index_buffer_offset_quad(&self) -> usize {
        return (self.quad_count_and_is_drawable_flag & 0xEFFFFFFF) as usize
            * 6
            * std::mem::size_of::<u32>();
    }
