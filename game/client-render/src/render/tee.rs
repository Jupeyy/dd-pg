...
use crate::containers::skins::{SkinMetrics, SkinTextures, TeeSkinEye};
...
impl RenderTee {
    pub fn new(graphics: &mut dyn GraphicsInterface) -> Self {
        ...
        let hand_offset = quad_container_handle.quad_container_add_quads(
            &tee_quad_container,
            &[SQuad::new().from_size_centered(20.0)],
        );
