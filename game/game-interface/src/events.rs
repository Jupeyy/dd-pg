...
pub enum GameWorldSystemMessage {
    ...
    PlayerJoined {
        id: PlayerId,
        name: PoolString,
        skin: MtPoolNetworkResourceKey<24>,
...
pub type GameWorldsEvents = PoolLinkedHashMap<StageId, GameWorldEvents>;
...
pub struct EventClientInfo {
    ...
    pub client_player_ids: PoolLinkedHashSet<PlayerId>,
