...
pub type SnapshotLocalPlayers = PoolLinkedHashMap<PlayerId, SnapshotLocalPlayer>;
...
pub enum FromSnapshotBuildMode {
    ...
    Unpredicted {
        keep_characters: PoolLinkedHashSet<CharacterId>,
    },
}
