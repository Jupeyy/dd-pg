...
use pool::{datatypes::PoolLinkedHashMap, rc::PoolRc};
...
pub struct CharacterInfo {
    ...
    /// Since overloading the skin color is such a common thing (team pvp),
    ...
    /// `false` for server side dummies or similar.
    pub is_player: bool,
}
