...
use pool::datatypes::{PoolLinkedHashMap, PoolString};
use serde::{Deserialize, Serialize};

use crate::types::{game::GameTickType, resource_key::PoolResourceKey, weapons::WeaponType};
...
#[derive(
    Debug, Hiarc, Default, Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Serialize, Deserialize,
)]
pub enum TeeEye {
    #[default]
    Normal = 0,
...
pub const TEE_EYE_COUNT: usize = 7;
...
pub struct CharacterInfo {
    pub name: PoolString,
    pub clan: PoolString,
    pub skin: PoolResourceKey,
    pub country: PoolString,
}
