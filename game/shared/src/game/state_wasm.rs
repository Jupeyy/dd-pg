...
pub mod state_wasm {
    ...
    use shared_game::{
        ...
        player::player::{PlayerInput, PlayerRenderInfo, PlayerScoreboardInfo},
        snapshot::snapshot::{Snapshot, SnapshotClientInfo},
        state::state::{
            GameStateCreateOptions, GameStateCreatePipe, GameStateInterface, GameStateTickInfo,
        },
    };
    ...
    pub struct StateWasm {
        ...
        api_collect_players_scoreboard_info_name: wasmer::TypedFunction<(), ()>,
    }
    ...
    impl StateWasm {
        pub fn new(
            ...
            let api_collect_players_scoreboard_info_name =
                wasm_manager.run_func_by_name("api_collect_players_scoreboard_info");
            Self {
                wasm_manager,
                ...
                api_collect_players_scoreboard_info_name,
            }
        }
    }
    ...
    impl StateWasm {
        ...
        #[wasm_func_auto_call(no_res)]
        fn api_collect_players_scoreboard_info(
            &self,
        ) -> (Vec<PlayerScoreboardInfo>, Vec<PlayerScoreboardInfo>) {
        }
    }
    ...
    impl GameStateInterface for StateWasm {
        ...
        fn collect_players_scoreboard_info(
            &self,
            ingame_scoreboard_infos: &mut Vec<PlayerScoreboardInfo>,
            spectator_scoreboard_infos: &mut Vec<PlayerScoreboardInfo>,
            _pool: &StringPool,
        ) {
            self.api_collect_players_scoreboard_info();
            let (ingame, spectator): (Vec<PlayerScoreboardInfo>, Vec<PlayerScoreboardInfo>) =
                self.wasm_manager.get_result_as();
            ingame_scoreboard_infos.extend(ingame);
            spectator_scoreboard_infos.extend(spectator);
        }
