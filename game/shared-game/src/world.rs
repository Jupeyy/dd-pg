pub mod world {
    ...
    use crate::{
        ...
        match_state::match_state::{Match, MatchType},
    ...
    impl GameWorld {
        pub fn new(
            ...
            if let Some(id_gen) = id_gen {
                ...
                let mut add_flag = |flags: &mut Flags, pos: &ivec2, ty: FlagType| {
                    let id = id_gen.next_id();
                    flags.insert(
                        id,
                        Flag::new(
        ...
        fn evaluate_character_team(&self) -> GameTeam {
            let mut red_team = 0;
            let mut blue_team = 0;
        ...
        pub fn add_character(
            ...
            let team = match match_state.ty {
                MatchType::Solo => None,
                MatchType::Team { .. } => Some(self.evaluate_character_team()),
            };
