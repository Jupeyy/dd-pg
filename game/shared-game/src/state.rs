pub mod state {
    ...
    use game_interface::client_commands::{ClientCameraMode, ClientCommand};
    use game_interface::events::{
        EventClientInfo, EventId, EventIdGenerator, GameBuffNinjaEventSound, GameBuffSoundEvent,
        GameCharacterEffectEvent, GameCharacterSoundEvent, GameEvents, GameGrenadeEventSound,
        GameLaserEventSound, GamePickupArmorEventSound, GamePickupHeartEventSound,
        GamePickupSoundEvent, GameShotgunEventSound, GameWorldAction, GameWorldEffectEvent,
        GameWorldEntityEffectEvent, GameWorldEntitySoundEvent, GameWorldEvent, GameWorldEvents,
        GameWorldNotificationEvent, GameWorldSoundEvent, GameWorldSystemMessage, KillFlags,
    };
    ...
    use game_interface::types::character_info::{
        NetworkCharacterInfo, NetworkLaserInfo, NetworkSkinInfo,
    };
    ...
    use game_interface::types::render::character::{
        ...
        CharacterPlayerInfo, CharacterRenderInfo, LocalCharacterRenderInfo, LocalCharacterVanilla,
        PlayerCameraMode, TeeEye,
    };
    ...
    pub struct Game {
        ...
        pub timeout_players: LinkedHashMap<(PlayerUniqueId, usize), (PlayerId, GameTickCooldown)>,
    ...
    pub struct GameState {
        ...
        pub player_events: FxHashMap<PlayerId, SimulationStageEvents>,
        ...
        pub(crate) no_char_player_clone_pool: Pool<LinkedHashMap<PlayerId, NoCharPlayer>>,
    ...
    impl GameStateCreate for GameState {
        ...
        where
            Self: Sized,
        {
            Self::new_impl(map, map_name, options, io_batcher, db).map_err(|err| err.to_string())
        }
    }

    impl GameState {
        fn add_stage(&mut self, name: String, stage_color: ubvec4) -> StageId {
            ...
            self.game.stages.insert(
                ...
                GameStage::new(
                    ...
                    self.game.simulation_events.init_stage(stage_id),
                ),
            );
            stage_id
        }
        ...
        pub(crate) fn insert_new_stage(
            ...
            simulation_events: &mut SimulationEvents,
        ) {
            stages.insert(
                stage_id,
                GameStage::new(
                    ...
                    id_gen,
                    game_options,
                    simulation_events.init_stage(stage_id),
                ),
            );
        }
        ...
        fn on_character_spawn(world: &mut GameWorld, character_id: &CharacterId) {
        ...
        pub fn player_tick(&mut self) {
            ...
            self.game.no_char_players.retain_with_order(hi_closure!(
                [
                    characters_to_spawn: &mut PoolLinkedHashMap<CharacterId, NoCharPlayer>
                ],
                |id: &PlayerId, no_char_player: &mut NoCharPlayer| -> bool {
                    ...
                    if let Ok(query) = query.get_storage() {
                        match query {
                            GameDbQueries::AccountInfo {
                                ...
                                events.push(SimulationWorldEvent::Notification(
        ...
        fn set_player_inp_impl(
            ...
            } else if self.game.no_char_players.contains_key(player_id) {
                self.game.no_char_players.handle_mut(
                    player_id,
                    hi_closure!(
                        [
                            inp: &CharacterInput,
                        ...
                        |no_char_player: &mut NoCharPlayer| -> () {
                            no_char_player.player_input = *inp;
                        }
                    ),
                );
            }
                        ...
                        match cmd.ident.as_str() {
                            "info" => {
                                self.game
                                    ...
                                    .unwrap()
                                    .simulation_events
                                    .push(SimulationWorldEvent::Notification(
                                        GameWorldNotificationEvent::System(
                                            GameWorldSystemMessage::Custom(
                                                self.game_pools
                                                    .mt_string_pool
        ...
        fn build_prev_from_stages(
            &mut self,
            snap_stages: PoolLinkedHashMap<StageId, SnapshotStage>,
        ) {
            SnapshotManager::convert_to_game_stages(
                ...
                &mut self.prev_game.simulation_events,
            );
            self.prev_game.simulation_events.clear_events();
        }
        ...
        fn stage_projectiles(
            ...
            ratio: f64,
        ) -> PoolLinkedHashMap<ProjectileId, ProjectileRenderInfo> {
        ...
        fn stage_ctf_flags(
            ...
            stage: Option<&GameStage>,
            ratio: f64,
        ) -> PoolLinkedHashMap<CtfFlagId, FlagRenderInfo> {
        ...
        fn stage_lasers(
            ...
            stage: Option<&GameStage>,
            ratio: f64,
        ) -> PoolLinkedHashMap<LaserId, LaserRenderInfo> {
        ...
        fn stage_pickups(
            ...
            stage: Option<&GameStage>,
            ratio: f64,
        ) -> PoolLinkedHashMap<PickupId, PickupRenderInfo> {
        ...
        fn stage_characters_render_info(
            ...
            stage: Option<&GameStage>,
            intra_tick_ratio: f64,
        ) -> PoolLinkedHashMap<CharacterId, CharacterRenderInfo> {
                ...
                PickupEvent::Pickup { pos, ty } => match ty {
                    PickupType::PowerupHealth => {
                        world_events.insert(
                            ...
                            GameWorldEvent::Sound(GameWorldSoundEvent {
                                pos: Some(pos),
                                owner_id,
                                ev: GameWorldEntitySoundEvent::Pickup(GamePickupSoundEvent::Heart(
                    ...
                    PickupType::PowerupArmor => {
                        world_events.insert(
                            ...
                            GameWorldEvent::Sound(GameWorldSoundEvent {
                                pos: Some(pos),
                                owner_id,
                                ev: GameWorldEntitySoundEvent::Pickup(GamePickupSoundEvent::Armor(
                    ...
                    PickupType::PowerupNinja => {
                        world_events.insert(
                            ...
                            GameWorldEvent::Sound(GameWorldSoundEvent {
                                pos: Some(pos),
                                owner_id,
                                ev: GameWorldEntitySoundEvent::Character(
                                    GameCharacterSoundEvent::Buff(GameBuffSoundEvent::Ninja(
                        ...
                        WeaponType::Shotgun => {
                            world_events.insert(
                                ...
                                GameWorldEvent::Sound(GameWorldSoundEvent {
                                    pos: Some(pos),
                                    owner_id,
                                    ev: GameWorldEntitySoundEvent::Shotgun(
                        ...
                        WeaponType::Grenade => {
                            world_events.insert(
                                ...
                                GameWorldEvent::Sound(GameWorldSoundEvent {
                                    pos: Some(pos),
                                    owner_id,
                                    ev: GameWorldEntitySoundEvent::Grenade(
                        ...
                        WeaponType::Laser => {
                            world_events.insert(
                                ...
                                GameWorldEvent::Sound(GameWorldSoundEvent {
                                    pos: Some(pos),
                                    owner_id,
                                    ev: GameWorldEntitySoundEvent::Laser(
        ...
        fn simulation_event_to_world_event(
            ...
            match simulation_event {
                SimulationWorldEvent::Entity(entity) => match entity.ev {
                    SimulationEventWorldEntityType::Character { ev } => match ev {
                        CharacterEvent::Despawn { killer_id, weapon } => {
                            world_events.insert(
                                event_id_generator.next_id(),
                                GameWorldEvent::Notification(GameWorldNotificationEvent::Action(
                                    GameWorldAction::Kill {
                                        killer: killer_id,
                                        assists: game_pools.character_id_pool.new(),
                                        victims: {
                                            let mut victims = game_pools.character_id_pool.new();
                        ...
                        CharacterEvent::Sound { pos, ev } => {
                            world_events.insert(
                                ...
                                GameWorldEvent::Sound(GameWorldSoundEvent {
                                    ...
                                    ev: GameWorldEntitySoundEvent::Character(
                                        GameCharacterSoundEvent::Sound(ev),
                                    ),
                                }),
                            );
                        }
                        CharacterEvent::Effect { pos, ev } => {
                            world_events.insert(
                                event_id_generator.next_id(),
                                GameWorldEvent::Effect(GameWorldEffectEvent {
                                    pos,
                                    owner_id: entity.owner_id,
                                    ev: GameWorldEntityEffectEvent::Character(
                                        GameCharacterEffectEvent::Effect(ev),
                                    ),
                                }),
                            );
                        }
                        CharacterEvent::BuffSound { pos, ev } => {
                            world_events.insert(
                                event_id_generator.next_id(),
                                GameWorldEvent::Sound(GameWorldSoundEvent {
                                    pos,
                                    owner_id: entity.owner_id,
                                    ev: GameWorldEntitySoundEvent::Character(
                                        GameCharacterSoundEvent::Buff(ev),
                                    ),
                                }),
                            );
                        }
                        CharacterEvent::BuffEffect { pos, ev } => {
                            world_events.insert(
                                event_id_generator.next_id(),
                                GameWorldEvent::Effect(GameWorldEffectEvent {
                                    pos,
                                    owner_id: entity.owner_id,
                                    ev: GameWorldEntityEffectEvent::Character(
                                        GameCharacterEffectEvent::Buff(ev),
                                    ),
                                }),
                            );
                        }
                        CharacterEvent::DebuffSound { pos, ev } => {
                            world_events.insert(
                                event_id_generator.next_id(),
                                GameWorldEvent::Sound(GameWorldSoundEvent {
                                    pos,
                                    owner_id: entity.owner_id,
                                    ev: GameWorldEntitySoundEvent::Character(
                                        GameCharacterSoundEvent::Debuff(ev),
                                    ),
                                }),
                            );
                        }
                        CharacterEvent::DebuffEffect { pos, ev } => {
                            world_events.insert(
                                event_id_generator.next_id(),
                                GameWorldEvent::Effect(GameWorldEffectEvent {
                                    pos,
                                    owner_id: entity.owner_id,
                                    ev: GameWorldEntityEffectEvent::Character(
                                        GameCharacterEffectEvent::Debuff(ev),
                                    ),
                                }),
                            );
                        }
                            ...
                            ProjectileEvent::GrenadeSound { pos, ev } => {
                                world_events.insert(
                                    ...
                                    GameWorldEvent::Sound(GameWorldSoundEvent {
                                        pos,
                                        owner_id: entity.owner_id,
                                        ev: GameWorldEntitySoundEvent::Grenade(ev),
                                    }),
                                );
                            }
                            ProjectileEvent::GrenadeEffect { pos, ev } => {
                                world_events.insert(
                                    ...
                                    GameWorldEvent::Effect(GameWorldEffectEvent {
                                        pos,
                                        owner_id: entity.owner_id,
                                        ev: GameWorldEntityEffectEvent::Grenade(ev),
                                    }),
                                );
                            }
                        }
                            ...
                            FlagEvent::Sound { pos, ev } => {
                                world_events.insert(
                                    ...
                                    GameWorldEvent::Sound(GameWorldSoundEvent {
                                        pos,
                                        owner_id: entity.owner_id,
                                        ev: GameWorldEntitySoundEvent::Flag(ev),
                                    }),
                                );
                            }
                            ...
                            LaserEvent::Sound { pos, ev } => {
                                world_events.insert(
                                    ...
                                    GameWorldEvent::Sound(GameWorldSoundEvent {
                                        pos,
                                        owner_id: entity.owner_id,
                                        ev: GameWorldEntitySoundEvent::Laser(ev),
                                    }),
                                );
                            }
                        }
                ...
                SimulationWorldEvent::Notification(ev) => {
                    world_events.insert(
                        event_id_generator.next_id(),
                        GameWorldEvent::Notification(ev.clone()),
                    );
                }
            }
        }
    ...
    impl GameStateInterface for GameState {
        fn collect_characters_info(&self) -> PoolLinkedHashMap<CharacterId, CharacterInfo> {
            ...
            let no_char_players = players.iter().map(|(_, player)| {
                let (player_info, stage_id) = match player.no_char_type {
                    NoCharPlayerType::Spectator {
                        spectated_character,
                    } => (
                        CharacterPlayerInfo {
                            cam_mode: match spectated_character {
                                Some(spectated_character) => {
                                    PlayerCameraMode::LockedOn(spectated_character)
                                }
                                None => PlayerCameraMode::Free,
                            },
                            force_scoreboard_visible: match spectated_character {
                                Some(spectated_character) => players
                                    .get(&spectated_character)
                                    .and_then(|p| {
                                        if let NoCharPlayerType::Dead { stage_id, .. } =
                                            &p.no_char_type
                                        {
                                            self.game.stages.get(stage_id)
                                        } else {
                                            None
                                        }
                                    })
        ...
        fn all_stages(&self, intra_tick_ratio: f64) -> PoolLinkedHashMap<StageId, StageRenderInfo> {
                                ...
                                MatchType::Solo => MatchStandings::Solo {
                                    leading_characters: {
                                        ...
                                        self.game.no_char_players.for_each(hi_closure!(
                                            [
                                                result: &mut [(i64, Option<CharacterId>); 2],
                                                stage_id: &StageId
                                            ],
                                            |no_char_id: &PlayerId, p: &NoCharPlayer| -> () {
                                                if let NoCharPlayerType::Dead {
                                                    score,
                                                    stage_id: char_stage_id,
                                                    ..
                                                } = &p.no_char_type
                                                {
                                                    if *char_stage_id != *stage_id {
                                                        return;
                                                    }
                                                    let score = *score;
                                                    if score > result[0].0 {
                ...
                .push(SimulationWorldEvent::Notification(
                    GameWorldNotificationEvent::System(GameWorldSystemMessage::PlayerJoined {
                        ...
                        skin: {
                            ...
                            (*skin).clone_from(&client_player_info.info.skin);
                            skin
                        },
                        skin_info: client_player_info.info.skin_info,
                    }),
                ));
        ...
        fn player_drop(&mut self, player_id: &PlayerId, _reason: PlayerDropReason) {
            let name = if let Some(server_player) = self.game.players.player(player_id) {
                ...
                let skin = {
                    let mut skin = self.game_pools.mt_resource_key_pool.new();
                    (*skin).clone_from(&no_char_player.player_info.player_info.skin);
                    skin
                };
                let skin_info = no_char_player.player_info.player_info.skin_info;
        ...
        fn network_stats(&mut self, mut stats: PoolLinkedHashMap<PlayerId, PlayerNetworkStats>) {
        ...
        fn client_command(&mut self, player_id: &PlayerId, cmd: ClientCommand) {
            match cmd {
                ...
                ClientCommand::SetCameraMode(mode) => {
                    if let Some(mut no_char_player) = self.game.no_char_players.player(player_id) {
                        // camera mode only works for spectators
                        if let NoCharPlayerType::Spectator {
                            spectated_character,
                        } = &mut no_char_player.no_char_type
                        {
                            *spectated_character = match mode {
                                ClientCameraMode::None => None,
                                ClientCameraMode::Normal(character)
                                | ClientCameraMode::Ghost(character) => character,
                            };
                        }
        ...
        fn set_player_inputs(&mut self, mut inps: PoolLinkedHashMap<PlayerId, CharacterInputInfo>) {
        ...
        fn events_for(&self, client: EventClientInfo) -> GameEvents {
            ...
            self.game.simulation_events.for_each(hi_closure!([
                game_pools: &GamePooling,
                event_id_generator: &EventIdGenerator,
                worlds_events_ref: &mut MtPoolLinkedHashMap<StageId, GameWorldEvents>,
            ], |world_id: &StageId, evs: &Vec<SimulationWorldEvent>|
             -> () {
        ...
        fn clear_events(&mut self) {
            self.game.simulation_events.clear_events();
