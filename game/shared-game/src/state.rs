pub mod state {
    ...
    use crate::player::player::{PlayerRenderInfo, PlayerScoreboardInfo};
    ...
    pub struct GameStateTickInfo {
        pub simulation_events: Vec<SimulationEvents>, // TODO: use a pool vec
    ...
    impl GameState {
        ...
        pub(crate) fn insert_new_pickup_to_stage(
            ...
            self.stages
                ...
                .unwrap()
                .world
                .insert_new_pickup(pickup_id, pos, &mut self.world_pool);
        }
        ...
        pub(crate) fn insert_new_flag_to_stage(
            ...
            self.stages
                ...
                .unwrap()
                .world
                .insert_new_flag(flag_id, pos, &mut self.world_pool);
        }
    ...
    impl GameStateInterface for GameState {
        ...
        fn collect_players_scoreboard_info(
            ...
            self.players.values().for_each(|p| {
                let mut skin_name = pool.new();
                let mut name = pool.new();
                skin_name.push_str(""); // TODO:
                name.push_str(p.player_info.name.as_str());
            ...
            self.no_char_players.values().for_each(|p| {
                let mut skin_name = pool.new();
                let mut name = pool.new();
                *skin_name = "".to_string(); // TODO:
                *name = p.player_info.name.as_str().to_string();
                spectator_scoreboard_infos.push(PlayerScoreboardInfo {
                    skin_name: skin_name,
                    player_name: name,
                });
            });
