        ...
        pub fn convert_to_game_state(
            ...
            snapshot.stages.values().for_each(|stage| {
                ...
                stage.world.lasers.values().for_each(|proj| {
                    ...
                    if !write_game_state.contains_laser(&stage.game_el_id, &proj.game_el_id) {
                        write_game_state.insert_new_laser_to_stage(
                            &stage.game_el_id,
                            proj.game_el_id.clone(),
                            proj.owner_game_el_id.clone(),
                            &proj.core.pos,
                ...
                stage.world.pickups.values().for_each(|proj| {
                    ...
                    if !write_game_state.contains_pickup(&stage.game_el_id, &proj.game_el_id) {
                        write_game_state.insert_new_pickup_to_stage(
                            &stage.game_el_id,
                            proj.game_el_id.clone(),
                            &proj.core.pos,
                        );
                ...
                stage.world.flags.values().for_each(|proj| {
                    ...
                    if !write_game_state.contains_flag(&stage.game_el_id, &proj.game_el_id) {
                        write_game_state.insert_new_flag_to_stage(
                            &stage.game_el_id,
                            proj.game_el_id.clone(),
                            &proj.core.pos,
                        );
