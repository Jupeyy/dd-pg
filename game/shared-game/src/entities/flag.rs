pub mod flag {
    ...
    use crate::{
        entities::{
            character::{character::CharactersView, core::character_core},
            entity::entity::{DropMode, Entity, EntityInterface, EntityTickResult},
        },
        events::events::FlagEvent,
        simulation_pipe::simulation_pipe::{
            SimulationEventWorldEntityType, SimulationPipeFlag, SimulationWorldEvents,
        },
    ...
    pub type PoolFlags = LinkedHashMap<CtfFlagId, Flag>;
    pub type Flags = PoolLinkedHashMap<CtfFlagId, Flag>;
}
