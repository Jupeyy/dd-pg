pub mod laser {
    ...
    use crate::simulation_pipe::simulation_pipe::{
        SimulationEventWorldEntityType, SimulationPipeLaser, SimulationWorldEvents,
    };
    ...
    pub type PoolLasers = LinkedHashMap<LaserId, WorldLaser>;
    pub type Lasers = PoolLinkedHashMap<LaserId, WorldLaser>;
}
