pub mod character_pos {
    ...
    impl CharacterPositionPlayfield {
        ...
        pub fn by_radiusf(&self, pos: &vec2, radius: f32) -> PoolVec<CharacterId> {
        ...
        pub fn by_radius(&self, pos: &vec2, radius: i32) -> PoolVec<CharacterId> {
            let mut res = self.vec_pool.new();
        ...
        pub fn by_radius_set(&self, pos: &vec2, radius: i32) -> PoolFxHashSet<CharacterId> {
    ...
    impl CharacterPos {
        ...
        pub fn in_rangef(&self, radius: f32) -> PoolVec<CharacterId> {
            self.field.by_radiusf(&self.pos, radius)
        }

        /// Generally faster than `in_rangef`
        pub fn in_range(&self, radius: i32) -> PoolVec<CharacterId> {
            self.field.by_radius(&self.pos, radius)
        }

        /// The returned set is not sorted in any way
        pub fn in_range_set(&self, radius: i32) -> PoolFxHashSet<CharacterId> {
