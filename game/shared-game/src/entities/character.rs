pub mod character {
    ...
    #[derive(Debug, Serialize, Deserialize, Copy, Clone, Default, Encode, Decode)]
    ...
    impl Character {
        ...
        fn fire_weapon(
            ...
            reusable_core: &mut CharacterReusableCore,
            cur_tick: GameTickType,
            _ticks_in_a_second: GameTickType,
        ) {
            if cur_tick - core.recoil_start_tick <= core.recoil_tick_amount {
                return;
            }
            ...
            let will_fire =
                *input.fire && (input.fire.change_version != core.recoil_click_ver || full_auto);
            ...
            // TODO: check all branches. make sure no code comments are in, before removing this comment
            match core.active_weapon {
                ...
                WeaponType::Laser => {
                    core.recoil_start_tick = cur_tick;
                    core.recoil_tick_amount = TICKS_UNTIL_RECOIL_ENDED;
                    ent.entity_events.push(EntitiyEvent::Laser {
                        pos: proj_start_pos,
                        dir: direction,
                    });
