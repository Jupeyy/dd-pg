pub mod pickup {
    use game_interface::types::{id_types::PickupId, pickup::PickupType};
    ...
    use crate::{
        ...
        simulation_pipe::simulation_pipe::{
            SimulationEventWorldEntityType, SimulationPipePickup, SimulationWorldEvents,
        },
    ...
    pub type PoolPickups = LinkedHashMap<PickupId, Pickup>;
    pub type Pickups = PoolLinkedHashMap<PickupId, Pickup>;
}
