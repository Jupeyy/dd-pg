pub mod projectile {
    ...
    use crate::simulation_pipe::simulation_pipe::{
        SimulationEventWorldEntityType, SimulationPipeProjectile, SimulationWorldEvents,
    };
    ...
    pub type PoolProjectiles = LinkedHashMap<ProjectileId, WorldProjectile>;
    pub type Projectiles = PoolLinkedHashMap<ProjectileId, WorldProjectile>;
}
