pub mod projectile {
    ...
    use crate::events::events::{EntityEvent, ProjectileEvent};
    ...
    pub struct Projectile {
        ...
        core: ProjectileCore,
        reusable_core: PoolProjectileReusableCore,

        pub(crate) entity_events: Vec<ProjectileEvent>,
    }
    ...
    impl Projectile {
        ...
        pub fn from(other: &Self, logger: SystemLogGroup, pool: &mut ProjectilePool) -> Self {
    ...
    impl<'a> EntityInterface<ProjectileCore, ProjectileReusableCore, SimulationPipeProjectile<'a>>
        for Projectile
    {
        fn pre_tick(&mut self, _pipe: &mut SimulationPipeProjectile) {
            todo!()
        }

        fn tick(&mut self, pipe: &mut SimulationPipeProjectile) {
                ...
                || Entity::outside_of_playfield(&cur_pos, pipe.collision)
            {
                ...
                if self.core.is_explosive {
                    self.entity_events
                        .push(ProjectileEvent::Entity(EntityEvent::Explosion {}));
                // TODO: GameServer()->CreateExplosion(cur_pos, m_Owner, m_Weapon, m_Damage);
                ...
                self.entity_events.push(ProjectileEvent::Despawn {
                    pos: self.core.pos,
        ...
        fn tick_deferred(&mut self, _pipe: &mut SimulationPipeProjectile) {
            // TODO: todo!()
        }

        fn split(&self) -> (&Entity, &ProjectileCore, &Recycle<ProjectileReusableCore>) {
