pub mod game_objects {
    use game_interface::types::weapons::{WeaponType, NUM_WEAPONS};
    use hiarc::Hiarc;
    ...
    impl GameObjectDefinitionsBase<ivec2> {
        pub fn new(game_layer_tiles: &Vec<TileBase>, width: u32, height: u32) -> Self {
