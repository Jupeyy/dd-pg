...
pub fn render(
    ...
    match &tools.active_tool {
                ...
                .show_inside(ui, |ui| {
                    egui::ScrollArea::horizontal().show(ui, |ui| {
                        ...
                        if main_frame_only {
                            ...
                            ui.horizontal(|ui| {
                                // mirror y
                                let mut btn = Button::new(icon_font_text(ui, "\u{f07d}"));
                                if ui
                                    .add(btn)
                                    .on_hover_ui(|ui| {
                                        let mut cache = egui_commonmark::CommonMarkCache::default();
                                ...
                                // mirror x
                                let mut btn = Button::new(icon_font_text(ui, "\u{f07e}"));
                                if ui.add(btn).clicked() {
                                    match tool {
                                        ActiveToolTiles::Brush => {
                                            if let Some(brush) = &mut tools.tiles.brush.brush {
                                ...
                                match tool {
                                    ActiveToolTiles::Brush => {
                                        // rotate -90°
                                        let mut btn = Button::new(icon_font_text(ui, "\u{f2ea}"));
                                        if ui.add(btn).clicked() {
                                            if let Some(brush) = &mut tools.tiles.brush.brush {
                                        ...
                                        // rotate +90°
                                        let mut btn = Button::new(icon_font_text(ui, "\u{f2f9}"));
                                        if ui.add(btn).clicked() {
                                            if let Some(brush) = &mut tools.tiles.brush.brush {
                                                rotate_tiles_plus_90(
                                                    pipe.user_data.tp,
                                        ...
                                        let mut btn = Button::new(icon_font_text(ui, "\u{e4f6}"));
                                        if ui.add(btn).clicked() {
                                            if let Some(brush) = &mut tools.tiles.brush.brush {
                ...
                .show_inside(ui, |ui| {
                    egui::ScrollArea::horizontal().show(ui, |ui| {
                        if main_frame_only {
                            ...
                            ui.horizontal(|ui| {
                                // add quad
                                let mut btn = Button::new(icon_font_text(ui, "\u{f0fe}"));
                                if ui
                                    .add(btn)
                                    .on_hover_ui(|ui| {
                                        let mut cache = egui_commonmark::CommonMarkCache::default();
        ...
        ActiveTool::Sounds(_) => todo!(),
    }

    super::tune::render(ui, pipe, ui_state, main_frame_only);
    super::switch::render(ui, pipe, ui_state, main_frame_only);
    super::tele::render(ui, pipe, ui_state, main_frame_only);
}
