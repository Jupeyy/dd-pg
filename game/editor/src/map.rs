...
pub trait EditorMapInterface {
    ...
    fn game_state_info(&self) -> GameStateRenderInfo;
...
impl Default for EditorGroupPanelResources {
    fn default() -> Self {
        Self {
...
pub struct EditorMapPropsUiValues {
    pub groups_panel_width: f32,
    pub group_panel_active_tab: EditorGroupPanelTab,
    pub animations_panel_height: f32,
