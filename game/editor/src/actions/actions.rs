...
pub enum EditorAction {
    ...
    ChangeQuadAttr(ActChangeQuadAttr),
...
impl EditorActionInterface for ActAddImage {
    fn undo_info(&self) -> String {
        format!("Remove image \"{}\"", &self.base.res.name)
    }

    fn redo_info(&self) -> String {
        format!("Add image \"{}\"", &self.base.res.name)
    }
}
...
impl EditorActionInterface for ActAddImage2dArray {
    fn undo_info(&self) -> String {
        format!("Remove image 2d array \"{}\"", &self.base.res.name)
    }

    fn redo_info(&self) -> String {
        format!("Add image 2d array \"{}\"", &self.base.res.name)
    }
}
...
impl EditorActionInterface for ActAddSound {
    fn undo_info(&self) -> String {
        format!("Remove sound \"{}\"", &self.base.res.name)
    }

    fn redo_info(&self) -> String {
        format!("Add sound \"{}\"", &self.base.res.name)
    }
}
...
impl EditorActionInterface for ActChangePhysicsGroupAttr {
    fn undo_info(&self) -> String {
        format!("Change attributes of physics group",)
    }
