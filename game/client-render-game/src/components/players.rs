...
pub struct PlayerRenderPipe<'a> {
    ...
    pub render_infos: &'a LinkedHashMap<CharacterId, CharacterRenderInfo>,
...
impl Players {
    ...
    fn render_info_iter<'a>(
        render_infos: &'a LinkedHashMap<CharacterId, CharacterRenderInfo>,
    ...
    pub fn render(&mut self, pipe: &mut PlayerRenderPipe) {
            ...
            Self::render_info_iter(render_infos, own_character)
        {
            ...
            let dir = normalize(&character_render_info.cursor_pos);
                    ...
                    skin.sounds
                        ...
                        .play(
                            SoundPlayProps::new_with_pos(pos)
                                .with_with_spartial(*spartial_sound)
    ...
    pub fn render_nameplates(
        ...
        cur_time: &Duration,
        camera: &Camera,
        render_infos: &PoolLinkedHashMap<CharacterId, CharacterRenderInfo>,
            ...
            Self::render_info_iter(render_infos, &own_character)
        {
            ...
            if let Some(name) = character_info
                ...
                .and_then(|n| {
                    (nameplates
                        && (own_nameplate || own_character.is_none_or(|id| *id != *character_id)))
                    .then_some(n)
                })
            {
