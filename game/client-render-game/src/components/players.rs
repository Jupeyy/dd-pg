...
impl Players {
    ...
    pub fn render(&mut self, pipe: &mut PlayerRenderPipe) {
        ...
        fn skin<'a>(
            ...
            ninja_skin: Option<
                Option<&game_interface::types::resource_key::NetworkResourceKey<24>>,
            >,
            ninjas: &'a mut client_containers::container::Container<
                client_containers::ninja::Ninja,
                client_containers::ninja::LoadNinja,
            >,
            skins: &'a mut client_containers::container::Container<
                std::rc::Rc<client_containers::skins::Skin>,
                client_containers::skins::LoadSkin,
            >,
        ) -> &'a Skin {
            ...
            let hook_hand = should_render_hook
                .then(|| {
                    self.toolkit_renderer
                        .render_hook(hooks, pos, player_render_info, state)
                })
                .flatten();
