...
use client_containers::{
    container::ContainerKey, ctf::CTFContainer, game::GameContainer, ninja::NinjaContainer,
...
impl GameObjectsRender {
    ...
    pub fn render_projectile(
        ...
        let weapon_name: ContainerKey = match ty {
    ...
    pub fn render_pickup(
        ...
        let (texture, quad_offset) = match ty {
            ...
            PickupType::PowerupWeapon(weapon) => {
                ...
                let weapon_tex = pipe
                    .weapon_container
                    .get_or_default::<ContainerKey>(&"TODO".try_into().unwrap()); // TODO:
                (
