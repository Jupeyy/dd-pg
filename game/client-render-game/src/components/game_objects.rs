...
impl GameObjectsRender {
    ...
    pub fn render_projectile(
        ...
        let weapon = pipe.weapon_container.get_or_default(&weapon_name.into());
    ...
    pub fn render_pickup(
        ...
        let (texture, quad_offset) = match ty {
            ...
            PickupType::PowerupWeapon(weapon) => {
                ...
                let weapon_tex = pipe.weapon_container.get_or_default(&"TODO:".into()); // TODO:
                (
            ...
            PickupType::PowerupNinja => {
                ...
                (
                    &pipe.ninja_container.get_or_default(&"TODO:".into()).weapon, // TODO:
    ...
    pub fn render_flag(
        ...
        let ctf_tex = pipe.ctf_container.get_or_default(&"TODO:".into());
