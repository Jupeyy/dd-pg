...
pub fn walk_anim() -> TeeAnimation {
    ...
    anim.left_foot.frames.push((
        Duration::from_millis(400),
        TeeAnimationFrame {
            pos: vec2::new(-10.0 / 32.0, -4.0 / 32.0),
            rotation: 0.2,
            scale: vec2::new(1.0, 1.0),
        },
    ));
    anim.left_foot.frames.push((
        Duration::from_millis(600),
        TeeAnimationFrame {
            pos: vec2::new(-8.0 / 32.0, -8.0 / 32.0),
            rotation: 0.3,
            scale: vec2::new(1.0, 1.0),
        },
    ));
...
pub fn run_left_anim() -> TeeAnimation {
    ...
    anim.left_foot.frames.push((
        Duration::from_millis(0),
        TeeAnimationFrame {
            pos: vec2::new(18.0 / 32.0, -8.0 / 32.0),
            rotation: -0.27,
            scale: vec2::new(1.0, 1.0),
        },
    ));
    ...
    anim.left_foot.frames.push((
        Duration::from_millis(600),
        TeeAnimationFrame {
            pos: vec2::new(-13.0 / 32.0, -4.5 / 32.0),
            rotation: 0.05,
            scale: vec2::new(1.0, 1.0),
        },
    ));
    ...
    anim.right_foot.frames.push((
        Duration::from_millis(0),
        TeeAnimationFrame {
            pos: vec2::new(-11.0 / 32.0, -2.5 / 32.0),
            rotation: 0.05,
            scale: vec2::new(1.0, 1.0),
        },
    ));
    anim.right_foot.frames.push((
        Duration::from_millis(200),
        TeeAnimationFrame {
            pos: vec2::new(-14.0 / 32.0, -5.0 / 32.0),
            rotation: 0.1,
            scale: vec2::new(1.0, 1.0),
        },
    ));
    anim.right_foot.frames.push((
        Duration::from_millis(400),
        TeeAnimationFrame {
            pos: vec2::new(11.0 / 32.0, -8.0 / 32.0),
            rotation: -0.3,
            scale: vec2::new(1.0, 1.0),
        },
    ));
