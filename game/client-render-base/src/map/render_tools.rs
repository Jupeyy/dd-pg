...
impl RenderTools {
    pub fn _render_tile_map<F, B: GraphicsBackendInterface>(
        ...
        F: Fn(&mut RenderPipelineBase<B>, i32, i32, &mut ColorRGBA),
    {
        ...
        let GraphicsHandles { stream_handle, .. } = pipe.graphics.get_handles();
    ...
    pub fn render_quads<F, B: GraphicsBackendInterface>(
        pipe: &mut RenderPipelineBase<B>,
        state: &State,
        quads: &Vec<CQuad>,
        num_quads: usize,
    ...
    pub fn force_render_quads<F, B: GraphicsBackendInterface>(
        pipe: &mut RenderPipelineBase<B>,
        _state: &State,
        quads: &Vec<CQuad>,
        num_quads: usize,
    ...
    pub fn map_canvas_to_group<B: GraphicsBackendInterface>(
        graphics: &GraphicsBase<B>,
        state: &mut State,
        center_x: f32,
        center_y: f32,
        group: &CMapItemGroup,
