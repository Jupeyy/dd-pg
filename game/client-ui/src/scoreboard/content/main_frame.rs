...
use shared_game::types::types::{PlayerScoreboardInfo, ScoreboardGameType};
...
fn render_scoreboard_frame(
    ...
    StripBuilder::new(ui)
        ...
        .vertical(|mut strip| {
            strip.cell(|ui| {
                super::topbar::render(ui, pipe, ui_state, graphics, topbar_type, rounding);
            });
            strip.empty();
            strip.cell(|ui| {
                super::list::list::render(ui, pipe, ui_state, graphics, &full_ui_rect, players);
            });
            strip.empty();
            strip.cell(|ui| {
...
pub fn render_players(
    ...
    match &pipe.user_data.game_data {
        ...
        ScoreboardGameType::SoloPlay { players, .. } => {
