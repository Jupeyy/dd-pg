...
use pool::{datatypes::StringPool, mt_datatypes::PoolVec, pool::Pool};
use shared_base::{
...
impl APIState {
    ...
    fn api_collect_players_scoreboard_info(
        ...
        let mut ingame_scoreboard_infos = Default::default();
        let mut spectator_scoreboard_infos = Default::default();
        self.state.collect_players_scoreboard_info(
            &mut ingame_scoreboard_infos,
            &mut spectator_scoreboard_infos,
            &Pool::with_capacity(64),
        );
        upload_return_val((ingame_scoreboard_infos, spectator_scoreboard_infos));
        Default::default()
    }
}
