...
//Rotation
pub const ROTATION_0: TileFlag = TileFlag::empty();
pub const ROTATION_90: TileFlag = TileFlag::ROTATE;
pub fn rotation_180() -> TileFlag {
    TileFlag::XFLIP | TileFlag::YFLIP
}
pub fn rotation_270() -> TileFlag {
    TileFlag::XFLIP | TileFlag::YFLIP | TileFlag::ROTATE
}
