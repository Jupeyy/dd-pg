...
use crate::mapdef::{
    ...
    CMapItemLayerTilemap, CMapItemSound, CMapItemVersion, CQuad, MapImage, MapItemTypes, MapLayer,
    MapLayerQuad, MapLayerTile, MapLayerTypes, MapTileLayerDetail, ReadFromSlice, TilesLayerFlag,
};
