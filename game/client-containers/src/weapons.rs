...
impl LoadWeapon {
    pub async fn load_weapon(
        ...
        let weapon_path = Path::new("weapons/");
...
impl LoadWeapons {
    pub async fn load_weapon(
        ...
        let mut weapon_path = Path::new("weapons/").to_path_buf();
        weapon_path.push(weapon_name);

        Ok(Self {
            // hammer
            hammer: LoadHammer::load_weapon(graphics_mt, sound_mt, fs, weapon_name, "hammer", 0, 0)
                .await?,
            // gun
            gun: LoadWeapon::load_weapon(graphics_mt, sound_mt, fs, weapon_name, "gun", 1, 3)
                .await?,
            // shotgun
            ...
            .await?,
            // laser
            laser: LoadLaser::load_weapon(graphics_mt, sound_mt, fs, weapon_name, "laser", 1, 0)
                .await?,
...
impl ContainerLoad<Weapons> for LoadWeapons {
    async fn load(
        ...
        Self::load_weapon(graphics_mt, sound_mt, fs.as_ref(), item_name).await
    }
