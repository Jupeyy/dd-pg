...
impl LoadWeapons {
    ...
    fn load_files_into_textures<B: GraphicsBackendInterface>(
        ...
        Weapons {
            hammer: LoadWeapon::load_files_into_textures(graphics, self.hammer, &self.weapon_name),
            ...
            laser: LoadWeapon::load_files_into_textures(graphics, self.laser, &self.weapon_name),
        }
    }
}
...
impl ContainerLoad<Weapons> for LoadWeapons {
    ...
    fn convert<B: GraphicsBackendInterface>(self, graphics: &mut GraphicsBase<B>) -> Weapons {
