...
use game_interface::types::{id_types::PlayerId, network_stats::PlayerNetworkStats};
...
pub struct ServerClient {
    pub players: PoolLinkedHashMap<PlayerId, ServerClientPlayer>,
    pub connect_timestamp: Duration,
...
impl ServerClient {
    pub fn new(
        connect_timestamp: &Duration,
        pool: &Pool<LinkedHashMap<PlayerId, ServerClientPlayer>>,
        ip: IpAddr,
        auth: ClientAuth,
        network_stats: PlayerNetworkStats,
    ) -> Self {
...
pub struct Clients {
    ...
    // pools
    players_pool: Pool<LinkedHashMap<PlayerId, ServerClientPlayer>>,
}
