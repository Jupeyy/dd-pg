...
use game_interface::{
    ...
    types::{game::GameTickType, reduced_ascii_str::ReducedAsciiString},
};
...
pub struct Demo {
    ...
    pub physics_module_name: ReducedAsciiString,
    pub render_game_module: Option<Vec<u8>>,
    pub map: Option<Vec<u8>>,
    pub map_name: ReducedAsciiString,
                ...
                if task.is_finished() {
                    ...
                    *self = Self::LoadingComponents {
                        client_map: ClientMapLoading::new(
                            ...
                            &io,
                            &thread_pool,
                            &demo.physics_module_name,
                            demo.physics_module
                                .as_ref()
                                .map(|module| generate_hash_for(module)),
                            false,
                            demo.game_options.clone(),
                        ),
                        demo,
                        io,
                    };
