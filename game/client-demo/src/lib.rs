...
use game_config::config::{ConfigGame, ConfigMap};
    ...
    fn render_game(
        ...
        let mut render_game_input = RenderGameInput {
            ...
            settings: RenderGameSettings {
                ...
                nameplates: true,
                nameplate_own: false,
                pixels_per_point: data.canvas_handle.window_pixels_per_point(),
            },
            ...
            .flatten()
        {
            ...
            render_game_input.settings.pixels_per_point = settings.pixels_per_point as f32;
        }
